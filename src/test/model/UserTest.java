...
public class UserTest {
    ...
    @BeforeEach
    public void setUp() {
        youngBoy = new User("Jake", 7, "M", 32.2, 121.6, 20150201);
        adultMale = new User("Ryan", 32, "M", 88.4, 178.9, 19900125);
        youngGirl = new User("Cecily", 11, "F", 37.7, 142.9, 20110111);
        adultWoman = new User("Lisa", 28, "F", 53.5, 164.5, 19940210);
        elderlyMan = new User("Jacob", 63, "M", 71.0, 177.3, 19590115);
        elderlyWoman = new User("Irene", 67, "F", 63.4, 168.2, 19550214);
    }
    ...
    public void testGetBirthDate() {
        assertEquals(20150201, youngBoy.getBirthDate());
        assertEquals(19900125, adultMale.getBirthDate());
        assertEquals(20110111, youngGirl.getBirthDate());
        assertEquals(19940210, adultWoman.getBirthDate());
    }
